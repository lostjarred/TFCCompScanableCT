# TFCCompScanableCT
Crafttweaker script to automatically add oredicts to all TFC ores so you can use something like scanable 

intended to be used with scanable 
https://www.curseforge.com/minecraft/mc-mods/scannable
#Install#
Install Crafttweaker, Install Scanable, Put this script in the "scripts" folder, find the Scanable config then add these entrys
to the config where you want to the ores to be scaned
